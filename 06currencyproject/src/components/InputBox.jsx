    ...
    return (
        ...
        ${className}`}>
            <div className="w-1/2">
                ...
                <input
                // id is generated here to bind both the input and the label
                    id= {amountInputId}
                    className="outline-none w-full bg-transparent py-1.5"
                    type="number"
                    placeholder="Amount"
                    disabled = {amountDisable}
                    //  In the above line disabled attribute gives us the option to disable a particular element in the webpage.
